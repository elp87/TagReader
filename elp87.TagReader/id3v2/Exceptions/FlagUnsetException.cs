...
namespace elp87.TagReader.id3v2.Exceptions
{
    ...
    public class FlagUnsetException : Exception
    {
        ...
        /// <summary>
        /// Initialize a new instance of <see cref="elp87.TagReader.id3v2.Exceptions.FlagUnsetException"/>
        /// </summary>
        public FlagUnsetException() { }

        /// <summary>
        /// Initialize a new instance of <see cref="elp87.TagReader.id3v2.Exceptions.FlagUnsetException"/> with a specified error message, cause of error and time of error.
        /// </summary>
